// A hand-drawn small icon per preset (drawn with createSvg, avoiding innerHTML; the colour follows the preset's theme colour).
...
/** Draw a preset's icon inside parent (color = the preset's theme colour, taking effect through currentColor) */
