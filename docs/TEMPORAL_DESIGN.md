...
merges again —— called from [`schema_v3.py:938`](../src/schema_v3.py) (inside `build_graph()`),
and folded by `merged[k]["docs"] |= set(e["docs"])` at [`schema_v3.py:938`](../src/schema_v3.py).
